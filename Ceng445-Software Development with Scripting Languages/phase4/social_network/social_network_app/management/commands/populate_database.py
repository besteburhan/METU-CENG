...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        names = ["Beste", "Beyza", "Edward", "Dimitri", "Janne",
                 "Evgeny", "Luis", "Olivia", "Amelia", "Valeria", "deneme"]

        # 10 user surnames

        surnames = ["Burhan", "Butun", "Rose", "Smith", "Johnson",
                    "Grinko", "Williams", "Oliver", "Brown", "Black", "deneme"]
        ...
        emails = ["besteburhan7@gmail.com", "beyzabtn3@gmail.com",
                  ...
                  "ameliabrown@gmail.com", "valeriablack@gmail.com", "d@d.com"]
        ...
        for i in range(5):
            ...
            receiver = user_objects[i + 6]
            friend = Friend(sender_user=sender, receiver_user=receiver, state=randint(0, 2))
            friend.save()

        for index in range(20):
            item_objects.append(Item.objects.create(owner=user_objects[index % 11], type=item_types[randint(0, 2)],
